/*
 * JS for song_48 generated by Appery.io
 */
...
function song_48_js() {
    ...
    Apperyio.CurrentScreen = 'song_48';
     ...
     */
    // On Load
    var song_48_onLoad = function() {
        song_48_elementsExtraJS();
        song_48_deviceEvents();
        song_48_windowEvents();
        song_48_elementsEvents();
    };
    // screen window events
    function song_48_windowEvents() {
        $('#song_48').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_48_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_48_elementsExtraJS() {
        // screen (song_48) extra code
    };
    // screen elements handler
    function song_48_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_48").on("pagebeforeshow", "#song_48", function(event, ui) {
        Apperyio.CurrentScreen = "song_48";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_48").on("pagecreate", "#song_48", function(event, ui) {

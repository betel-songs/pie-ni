/*
 * JS for song_20 generated by Appery.io
 */
...
function song_20_js() {
    ...
    Apperyio.CurrentScreen = 'song_20';
     ...
     */
    // On Load
    var song_20_onLoad = function() {
        song_20_elementsExtraJS();
        song_20_deviceEvents();
        song_20_windowEvents();
        song_20_elementsEvents();
    };
    // screen window events
    function song_20_windowEvents() {
        $('#song_20').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_20_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_20_elementsExtraJS() {
        // screen (song_20) extra code
    };
    // screen elements handler
    function song_20_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_20").on("pagebeforeshow", "#song_20", function(event, ui) {
        Apperyio.CurrentScreen = "song_20";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_20").on("pagecreate", "#song_20", function(event, ui) {

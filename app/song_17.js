/*
 * JS for song_17 generated by Appery.io
 */
...
function song_17_js() {
    ...
    Apperyio.CurrentScreen = 'song_17';
     ...
     */
    // On Load
    var song_17_onLoad = function() {
        song_17_elementsExtraJS();
        song_17_deviceEvents();
        song_17_windowEvents();
        song_17_elementsEvents();
    };
    // screen window events
    function song_17_windowEvents() {
        $('#song_17').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_17_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_17_elementsExtraJS() {
        // screen (song_17) extra code
    };
    // screen elements handler
    function song_17_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_17").on("pagebeforeshow", "#song_17", function(event, ui) {
        Apperyio.CurrentScreen = "song_17";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_17").on("pagecreate", "#song_17", function(event, ui) {

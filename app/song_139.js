...
function song_139_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_139_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_139';
     ...
     */
    // On Load
    var song_139_onLoad = function() {
        song_139_elementsExtraJS();
        song_139_deviceEvents();
        song_139_windowEvents();
        song_139_elementsEvents();
    };
    // screen window events
    function song_139_windowEvents() {
        $('#song_139').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_139_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_139_elementsExtraJS() {
        // screen (song_139) extra code
    };
    // screen elements handler
    function song_139_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_139").on("pagebeforeshow", "#song_139", function(event, ui) {
        Apperyio.CurrentScreen = "song_139";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_139").on("pagecreate", "#song_139", function(event, ui) {

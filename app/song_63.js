/*
 * JS for song_63 generated by Appery.io
 */
...
function song_63_js() {
    ...
    Apperyio.CurrentScreen = 'song_63';
     ...
     */
    // On Load
    var song_63_onLoad = function() {
        song_63_elementsExtraJS();
        song_63_deviceEvents();
        song_63_windowEvents();
        song_63_elementsEvents();
    };
    // screen window events
    function song_63_windowEvents() {
        $('#song_63').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_63_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_63_elementsExtraJS() {
        // screen (song_63) extra code
    };
    // screen elements handler
    function song_63_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_63").on("pagebeforeshow", "#song_63", function(event, ui) {
        Apperyio.CurrentScreen = "song_63";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_63").on("pagecreate", "#song_63", function(event, ui) {

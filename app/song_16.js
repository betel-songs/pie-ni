/*
 * JS for song_16 generated by Appery.io
 */
...
function song_16_js() {
    ...
    Apperyio.CurrentScreen = 'song_16';
     ...
     */
    // On Load
    var song_16_onLoad = function() {
        song_16_elementsExtraJS();
        song_16_deviceEvents();
        song_16_windowEvents();
        song_16_elementsEvents();
    };
    // screen window events
    function song_16_windowEvents() {
        $('#song_16').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_16_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_16_elementsExtraJS() {
        // screen (song_16) extra code
    };
    // screen elements handler
    function song_16_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_16").on("pagebeforeshow", "#song_16", function(event, ui) {
        Apperyio.CurrentScreen = "song_16";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_16").on("pagecreate", "#song_16", function(event, ui) {

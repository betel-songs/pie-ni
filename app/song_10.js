/*
 * JS for song_10 generated by Appery.io
 */
...
function song_10_js() {
    ...
    Apperyio.CurrentScreen = 'song_10';
     ...
     */
    // On Load
    var song_10_onLoad = function() {
        song_10_elementsExtraJS();
        song_10_deviceEvents();
        song_10_windowEvents();
        song_10_elementsEvents();
    };
    // screen window events
    function song_10_windowEvents() {
        $('#song_10').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_10_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_10_elementsExtraJS() {
        // screen (song_10) extra code
    };
    // screen elements handler
    function song_10_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_10").on("pagebeforeshow", "#song_10", function(event, ui) {
        Apperyio.CurrentScreen = "song_10";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_10").on("pagecreate", "#song_10", function(event, ui) {

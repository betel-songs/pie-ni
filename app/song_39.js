/*
 * JS for song_39 generated by Appery.io
 */
...
function song_39_js() {
    ...
    Apperyio.CurrentScreen = 'song_39';
     ...
     */
    // On Load
    var song_39_onLoad = function() {
        song_39_elementsExtraJS();
        song_39_deviceEvents();
        song_39_windowEvents();
        song_39_elementsEvents();
    };
    // screen window events
    function song_39_windowEvents() {
        $('#song_39').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_39_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_39_elementsExtraJS() {
        // screen (song_39) extra code
    };
    // screen elements handler
    function song_39_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_39").on("pagebeforeshow", "#song_39", function(event, ui) {
        Apperyio.CurrentScreen = "song_39";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_39").on("pagecreate", "#song_39", function(event, ui) {

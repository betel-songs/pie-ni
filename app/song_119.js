/*
 * JS for song_119 generated by Appery.io
 */
...
function song_119_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_119_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_119';
     ...
     */
    // On Load
    var song_119_onLoad = function() {
        song_119_elementsExtraJS();
        song_119_deviceEvents();
        song_119_windowEvents();
        song_119_elementsEvents();
    };
    // screen window events
    function song_119_windowEvents() {
        $('#song_119').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_119_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_119_elementsExtraJS() {
        // screen (song_119) extra code
    };
    // screen elements handler
    function song_119_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_119").on("pagebeforeshow", "#song_119", function(event, ui) {
        Apperyio.CurrentScreen = "song_119";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_119").on("pagecreate", "#song_119", function(event, ui) {

/*
 * JS for song_66 generated by Appery.io
 */
...
function song_66_js() {
    ...
    Apperyio.CurrentScreen = 'song_66';
     ...
     */
    // On Load
    var song_66_onLoad = function() {
        song_66_elementsExtraJS();
        song_66_deviceEvents();
        song_66_windowEvents();
        song_66_elementsEvents();
    };
    // screen window events
    function song_66_windowEvents() {
        $('#song_66').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_66_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_66_elementsExtraJS() {
        // screen (song_66) extra code
    };
    // screen elements handler
    function song_66_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_66").on("pagebeforeshow", "#song_66", function(event, ui) {
        Apperyio.CurrentScreen = "song_66";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_66").on("pagecreate", "#song_66", function(event, ui) {

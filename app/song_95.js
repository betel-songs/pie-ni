/*
 * JS for song_95 generated by Appery.io
 */
...
function song_95_js() {
    ...
    Apperyio.CurrentScreen = 'song_95';
     ...
     */
    // On Load
    var song_95_onLoad = function() {
        song_95_elementsExtraJS();
        song_95_deviceEvents();
        song_95_windowEvents();
        song_95_elementsEvents();
    };
    // screen window events
    function song_95_windowEvents() {
        $('#song_95').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_95_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_95_elementsExtraJS() {
        // screen (song_95) extra code
    };
    // screen elements handler
    function song_95_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_95").on("pagebeforeshow", "#song_95", function(event, ui) {
        Apperyio.CurrentScreen = "song_95";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_95").on("pagecreate", "#song_95", function(event, ui) {

/*
 * JS for song_47 generated by Appery.io
 */
...
function song_47_js() {
    ...
    Apperyio.CurrentScreen = 'song_47';
     ...
     */
    // On Load
    var song_47_onLoad = function() {
        song_47_elementsExtraJS();
        song_47_deviceEvents();
        song_47_windowEvents();
        song_47_elementsEvents();
    };
    // screen window events
    function song_47_windowEvents() {
        $('#song_47').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_47_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_47_elementsExtraJS() {
        // screen (song_47) extra code
    };
    // screen elements handler
    function song_47_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_47").on("pagebeforeshow", "#song_47", function(event, ui) {
        Apperyio.CurrentScreen = "song_47";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_47").on("pagecreate", "#song_47", function(event, ui) {

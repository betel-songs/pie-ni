/*
 * JS for song_14 generated by Appery.io
 */
...
function song_14_js() {
    ...
    Apperyio.CurrentScreen = 'song_14';
     ...
     */
    // On Load
    var song_14_onLoad = function() {
        song_14_elementsExtraJS();
        song_14_deviceEvents();
        song_14_windowEvents();
        song_14_elementsEvents();
    };
    // screen window events
    function song_14_windowEvents() {
        $('#song_14').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_14_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_14_elementsExtraJS() {
        // screen (song_14) extra code
    };
    // screen elements handler
    function song_14_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_14").on("pagebeforeshow", "#song_14", function(event, ui) {
        Apperyio.CurrentScreen = "song_14";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_14").on("pagecreate", "#song_14", function(event, ui) {

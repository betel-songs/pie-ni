/*
 * JS for song_106 generated by Appery.io
 */
...
function song_106_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_106_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_106';
     ...
     */
    // On Load
    var song_106_onLoad = function() {
        song_106_elementsExtraJS();
        song_106_deviceEvents();
        song_106_windowEvents();
        song_106_elementsEvents();
    };
    // screen window events
    function song_106_windowEvents() {
        $('#song_106').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_106_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_106_elementsExtraJS() {
        // screen (song_106) extra code
    };
    // screen elements handler
    function song_106_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_106").on("pagebeforeshow", "#song_106", function(event, ui) {
        Apperyio.CurrentScreen = "song_106";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_106").on("pagecreate", "#song_106", function(event, ui) {

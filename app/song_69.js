/*
 * JS for song_69 generated by Appery.io
 */
...
function song_69_js() {
    ...
    Apperyio.CurrentScreen = 'song_69';
     ...
     */
    // On Load
    var song_69_onLoad = function() {
        song_69_elementsExtraJS();
        song_69_deviceEvents();
        song_69_windowEvents();
        song_69_elementsEvents();
    };
    // screen window events
    function song_69_windowEvents() {
        $('#song_69').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_69_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_69_elementsExtraJS() {
        // screen (song_69) extra code
    };
    // screen elements handler
    function song_69_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_69").on("pagebeforeshow", "#song_69", function(event, ui) {
        Apperyio.CurrentScreen = "song_69";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_69").on("pagecreate", "#song_69", function(event, ui) {

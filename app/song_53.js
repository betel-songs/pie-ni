/*
 * JS for song_53 generated by Appery.io
 */
...
function song_53_js() {
    ...
    Apperyio.CurrentScreen = 'song_53';
     ...
     */
    // On Load
    var song_53_onLoad = function() {
        song_53_elementsExtraJS();
        song_53_deviceEvents();
        song_53_windowEvents();
        song_53_elementsEvents();
    };
    // screen window events
    function song_53_windowEvents() {
        $('#song_53').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_53_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_53_elementsExtraJS() {
        // screen (song_53) extra code
    };
    // screen elements handler
    function song_53_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_53").on("pagebeforeshow", "#song_53", function(event, ui) {
        Apperyio.CurrentScreen = "song_53";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_53").on("pagecreate", "#song_53", function(event, ui) {

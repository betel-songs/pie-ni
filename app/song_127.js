/*
 * JS for song_127 generated by Appery.io
 */
...
function song_127_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_127_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_127';
     ...
     */
    // On Load
    var song_127_onLoad = function() {
        song_127_elementsExtraJS();
        song_127_deviceEvents();
        song_127_windowEvents();
        song_127_elementsEvents();
    };
    // screen window events
    function song_127_windowEvents() {
        $('#song_127').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_127_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_127_elementsExtraJS() {
        // screen (song_127) extra code
    };
    // screen elements handler
    function song_127_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_127").on("pagebeforeshow", "#song_127", function(event, ui) {
        Apperyio.CurrentScreen = "song_127";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_127").on("pagecreate", "#song_127", function(event, ui) {

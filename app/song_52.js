/*
 * JS for song_52 generated by Appery.io
 */
...
function song_52_js() {
    ...
    Apperyio.CurrentScreen = 'song_52';
     ...
     */
    // On Load
    var song_52_onLoad = function() {
        song_52_elementsExtraJS();
        song_52_deviceEvents();
        song_52_windowEvents();
        song_52_elementsEvents();
    };
    // screen window events
    function song_52_windowEvents() {
        $('#song_52').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_52_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_52_elementsExtraJS() {
        // screen (song_52) extra code
    };
    // screen elements handler
    function song_52_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_52").on("pagebeforeshow", "#song_52", function(event, ui) {
        Apperyio.CurrentScreen = "song_52";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_52").on("pagecreate", "#song_52", function(event, ui) {

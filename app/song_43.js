/*
 * JS for song_43 generated by Appery.io
 */
...
function song_43_js() {
    ...
    Apperyio.CurrentScreen = 'song_43';
     ...
     */
    // On Load
    var song_43_onLoad = function() {
        song_43_elementsExtraJS();
        song_43_deviceEvents();
        song_43_windowEvents();
        song_43_elementsEvents();
    };
    // screen window events
    function song_43_windowEvents() {
        $('#song_43').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_43_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_43_elementsExtraJS() {
        // screen (song_43) extra code
    };
    // screen elements handler
    function song_43_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_43").on("pagebeforeshow", "#song_43", function(event, ui) {
        Apperyio.CurrentScreen = "song_43";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_43").on("pagecreate", "#song_43", function(event, ui) {

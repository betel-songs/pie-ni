/*
 * JS for song_6 generated by Appery.io
 */
...
function song_6_js() {
     ...
     */
    // On Load
    var song_6_onLoad = function() {
        song_6_elementsExtraJS();
        song_6_deviceEvents();
        song_6_windowEvents();
        song_6_elementsEvents();
    };
    // screen window events
    function song_6_windowEvents() {
        $('#song_6').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_6_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_6_elementsExtraJS() {
        // screen (song_6) extra code
    };
    // screen elements handler
    function song_6_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_6").on("pagebeforeshow", "#song_6", function(event, ui) {
        Apperyio.CurrentScreen = "song_6";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_6").on("pagecreate", "#song_6", function(event, ui) {

/*
 * JS for song_11 generated by Appery.io
 */
...
function song_11_js() {
    ...
    Apperyio.CurrentScreen = 'song_11';
     ...
     */
    // On Load
    var song_11_onLoad = function() {
        song_11_elementsExtraJS();
        song_11_deviceEvents();
        song_11_windowEvents();
        song_11_elementsEvents();
    };
    // screen window events
    function song_11_windowEvents() {
        $('#song_11').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_11_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_11_elementsExtraJS() {
        // screen (song_11) extra code
    };
    // screen elements handler
    function song_11_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_11").on("pagebeforeshow", "#song_11", function(event, ui) {
        Apperyio.CurrentScreen = "song_11";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_11").on("pagecreate", "#song_11", function(event, ui) {

/*
 * JS for song_73 generated by Appery.io
 */
...
function song_73_js() {
    ...
    Apperyio.CurrentScreen = 'song_73';
     ...
     */
    // On Load
    var song_73_onLoad = function() {
        song_73_elementsExtraJS();
        song_73_deviceEvents();
        song_73_windowEvents();
        song_73_elementsEvents();
    };
    // screen window events
    function song_73_windowEvents() {
        $('#song_73').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_73_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_73_elementsExtraJS() {
        // screen (song_73) extra code
    };
    // screen elements handler
    function song_73_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_73").on("pagebeforeshow", "#song_73", function(event, ui) {
        Apperyio.CurrentScreen = "song_73";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_73").on("pagecreate", "#song_73", function(event, ui) {

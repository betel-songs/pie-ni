/*
 * JS for song_51 generated by Appery.io
 */
...
function song_51_js() {
    ...
    Apperyio.CurrentScreen = 'song_51';
     ...
     */
    // On Load
    var song_51_onLoad = function() {
        song_51_elementsExtraJS();
        song_51_deviceEvents();
        song_51_windowEvents();
        song_51_elementsEvents();
    };
    // screen window events
    function song_51_windowEvents() {
        $('#song_51').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_51_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_51_elementsExtraJS() {
        // screen (song_51) extra code
    };
    // screen elements handler
    function song_51_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_51").on("pagebeforeshow", "#song_51", function(event, ui) {
        Apperyio.CurrentScreen = "song_51";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_51").on("pagecreate", "#song_51", function(event, ui) {

/*
 * JS for song_24 generated by Appery.io
 */
...
function song_24_js() {
    ...
    Apperyio.CurrentScreen = 'song_24';
     ...
     */
    // On Load
    var song_24_onLoad = function() {
        song_24_elementsExtraJS();
        song_24_deviceEvents();
        song_24_windowEvents();
        song_24_elementsEvents();
    };
    // screen window events
    function song_24_windowEvents() {
        $('#song_24').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_24_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_24_elementsExtraJS() {
        // screen (song_24) extra code
    };
    // screen elements handler
    function song_24_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_24").on("pagebeforeshow", "#song_24", function(event, ui) {
        Apperyio.CurrentScreen = "song_24";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_24").on("pagecreate", "#song_24", function(event, ui) {

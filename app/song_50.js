/*
 * JS for song_50 generated by Appery.io
 */
...
function song_50_js() {
    ...
    Apperyio.CurrentScreen = 'song_50';
     ...
     */
    // On Load
    var song_50_onLoad = function() {
        song_50_elementsExtraJS();
        song_50_deviceEvents();
        song_50_windowEvents();
        song_50_elementsEvents();
    };
    // screen window events
    function song_50_windowEvents() {
        $('#song_50').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_50_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_50_elementsExtraJS() {
        // screen (song_50) extra code
    };
    // screen elements handler
    function song_50_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_50").on("pagebeforeshow", "#song_50", function(event, ui) {
        Apperyio.CurrentScreen = "song_50";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_50").on("pagecreate", "#song_50", function(event, ui) {

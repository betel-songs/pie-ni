/*
 * JS for song_12 generated by Appery.io
 */
...
function song_12_js() {
    ...
    Apperyio.CurrentScreen = 'song_12';
     ...
     */
    // On Load
    var song_12_onLoad = function() {
        song_12_elementsExtraJS();
        song_12_deviceEvents();
        song_12_windowEvents();
        song_12_elementsEvents();
    };
    // screen window events
    function song_12_windowEvents() {
        $('#song_12').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_12_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_12_elementsExtraJS() {
        // screen (song_12) extra code
    };
    // screen elements handler
    function song_12_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_12").on("pagebeforeshow", "#song_12", function(event, ui) {
        Apperyio.CurrentScreen = "song_12";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_12").on("pagecreate", "#song_12", function(event, ui) {

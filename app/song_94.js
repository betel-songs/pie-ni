/*
 * JS for song_94 generated by Appery.io
 */
...
function song_94_js() {
    ...
    Apperyio.CurrentScreen = 'song_94';
     ...
     */
    // On Load
    var song_94_onLoad = function() {
        song_94_elementsExtraJS();
        song_94_deviceEvents();
        song_94_windowEvents();
        song_94_elementsEvents();
    };
    // screen window events
    function song_94_windowEvents() {
        $('#song_94').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_94_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_94_elementsExtraJS() {
        // screen (song_94) extra code
    };
    // screen elements handler
    function song_94_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_94").on("pagebeforeshow", "#song_94", function(event, ui) {
        Apperyio.CurrentScreen = "song_94";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_94").on("pagecreate", "#song_94", function(event, ui) {

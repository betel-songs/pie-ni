/*
 * JS for song_100 generated by Appery.io
 */
...
function song_100_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_100_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_100';
     ...
     */
    // On Load
    var song_100_onLoad = function() {
        song_100_elementsExtraJS();
        song_100_deviceEvents();
        song_100_windowEvents();
        song_100_elementsEvents();
    };
    // screen window events
    function song_100_windowEvents() {
        $('#song_100').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_100_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_100_elementsExtraJS() {
        // screen (song_100) extra code
    };
    // screen elements handler
    function song_100_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_100").on("pagebeforeshow", "#song_100", function(event, ui) {
        Apperyio.CurrentScreen = "song_100";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_100").on("pagecreate", "#song_100", function(event, ui) {

/*
 * JS for song_91 generated by Appery.io
 */
...
function song_91_js() {
    ...
    Apperyio.CurrentScreen = 'song_91';
     ...
     */
    // On Load
    var song_91_onLoad = function() {
        song_91_elementsExtraJS();
        song_91_deviceEvents();
        song_91_windowEvents();
        song_91_elementsEvents();
    };
    // screen window events
    function song_91_windowEvents() {
        $('#song_91').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_91_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_91_elementsExtraJS() {
        // screen (song_91) extra code
    };
    // screen elements handler
    function song_91_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_91").on("pagebeforeshow", "#song_91", function(event, ui) {
        Apperyio.CurrentScreen = "song_91";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_91").on("pagecreate", "#song_91", function(event, ui) {

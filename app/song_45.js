/*
 * JS for song_45 generated by Appery.io
 */
...
function song_45_js() {
    ...
    Apperyio.CurrentScreen = 'song_45';
     ...
     */
    // On Load
    var song_45_onLoad = function() {
        song_45_elementsExtraJS();
        song_45_deviceEvents();
        song_45_windowEvents();
        song_45_elementsEvents();
    };
    // screen window events
    function song_45_windowEvents() {
        $('#song_45').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_45_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_45_elementsExtraJS() {
        // screen (song_45) extra code
    };
    // screen elements handler
    function song_45_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_45").on("pagebeforeshow", "#song_45", function(event, ui) {
        Apperyio.CurrentScreen = "song_45";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_45").on("pagecreate", "#song_45", function(event, ui) {

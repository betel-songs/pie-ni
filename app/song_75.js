/*
 * JS for song_75 generated by Appery.io
 */
...
function song_75_js() {
    ...
    Apperyio.CurrentScreen = 'song_75';
     ...
     */
    // On Load
    var song_75_onLoad = function() {
        song_75_elementsExtraJS();
        song_75_deviceEvents();
        song_75_windowEvents();
        song_75_elementsEvents();
    };
    // screen window events
    function song_75_windowEvents() {
        $('#song_75').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_75_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_75_elementsExtraJS() {
        // screen (song_75) extra code
    };
    // screen elements handler
    function song_75_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_75").on("pagebeforeshow", "#song_75", function(event, ui) {
        Apperyio.CurrentScreen = "song_75";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_75").on("pagecreate", "#song_75", function(event, ui) {

/*
 * JS for song_123 generated by Appery.io
 */
...
function song_123_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_123_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_123';
     ...
     */
    // On Load
    var song_123_onLoad = function() {
        song_123_elementsExtraJS();
        song_123_deviceEvents();
        song_123_windowEvents();
        song_123_elementsEvents();
    };
    // screen window events
    function song_123_windowEvents() {
        $('#song_123').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_123_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_123_elementsExtraJS() {
        // screen (song_123) extra code
    };
    // screen elements handler
    function song_123_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_123").on("pagebeforeshow", "#song_123", function(event, ui) {
        Apperyio.CurrentScreen = "song_123";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_123").on("pagecreate", "#song_123", function(event, ui) {

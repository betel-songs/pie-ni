/*
 * JS for song_89 generated by Appery.io
 */
...
function song_89_js() {
    ...
    Apperyio.CurrentScreen = 'song_89';
     ...
     */
    // On Load
    var song_89_onLoad = function() {
        song_89_elementsExtraJS();
        song_89_deviceEvents();
        song_89_windowEvents();
        song_89_elementsEvents();
    };
    // screen window events
    function song_89_windowEvents() {
        $('#song_89').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_89_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_89_elementsExtraJS() {
        // screen (song_89) extra code
    };
    // screen elements handler
    function song_89_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_89").on("pagebeforeshow", "#song_89", function(event, ui) {
        Apperyio.CurrentScreen = "song_89";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_89").on("pagecreate", "#song_89", function(event, ui) {

/*
 * JS for song_96 generated by Appery.io
 */
...
function song_96_js() {
    ...
    Apperyio.CurrentScreen = 'song_96';
     ...
     */
    // On Load
    var song_96_onLoad = function() {
        song_96_elementsExtraJS();
        song_96_deviceEvents();
        song_96_windowEvents();
        song_96_elementsEvents();
    };
    // screen window events
    function song_96_windowEvents() {
        $('#song_96').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_96_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_96_elementsExtraJS() {
        // screen (song_96) extra code
    };
    // screen elements handler
    function song_96_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_96").on("pagebeforeshow", "#song_96", function(event, ui) {
        Apperyio.CurrentScreen = "song_96";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_96").on("pagecreate", "#song_96", function(event, ui) {

/*
 * JS for song_55 generated by Appery.io
 */
...
function song_55_js() {
    ...
    Apperyio.CurrentScreen = 'song_55';
     ...
     */
    // On Load
    var song_55_onLoad = function() {
        song_55_elementsExtraJS();
        song_55_deviceEvents();
        song_55_windowEvents();
        song_55_elementsEvents();
    };
    // screen window events
    function song_55_windowEvents() {
        $('#song_55').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_55_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_55_elementsExtraJS() {
        // screen (song_55) extra code
    };
    // screen elements handler
    function song_55_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_55").on("pagebeforeshow", "#song_55", function(event, ui) {
        Apperyio.CurrentScreen = "song_55";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_55").on("pagecreate", "#song_55", function(event, ui) {

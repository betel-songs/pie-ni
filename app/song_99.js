/*
 * JS for song_99 generated by Appery.io
 */
...
function song_99_js() {
    ...
    Apperyio.CurrentScreen = 'song_99';
     ...
     */
    // On Load
    var song_99_onLoad = function() {
        song_99_elementsExtraJS();
        song_99_deviceEvents();
        song_99_windowEvents();
        song_99_elementsEvents();
    };
    // screen window events
    function song_99_windowEvents() {
        $('#song_99').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_99_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_99_elementsExtraJS() {
        // screen (song_99) extra code
    };
    // screen elements handler
    function song_99_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_99").on("pagebeforeshow", "#song_99", function(event, ui) {
        Apperyio.CurrentScreen = "song_99";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_99").on("pagecreate", "#song_99", function(event, ui) {

/*
 * JS for song_131 generated by Appery.io
 */
...
function song_131_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_131_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_131';
     ...
     */
    // On Load
    var song_131_onLoad = function() {
        song_131_elementsExtraJS();
        song_131_deviceEvents();
        song_131_windowEvents();
        song_131_elementsEvents();
    };
    // screen window events
    function song_131_windowEvents() {
        $('#song_131').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_131_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_131_elementsExtraJS() {
        // screen (song_131) extra code
    };
    // screen elements handler
    function song_131_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_131").on("pagebeforeshow", "#song_131", function(event, ui) {
        Apperyio.CurrentScreen = "song_131";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_131").on("pagecreate", "#song_131", function(event, ui) {

/*
 * JS for song_41 generated by Appery.io
 */
...
function song_41_js() {
    ...
    Apperyio.CurrentScreen = 'song_41';
     ...
     */
    // On Load
    var song_41_onLoad = function() {
        song_41_elementsExtraJS();
        song_41_deviceEvents();
        song_41_windowEvents();
        song_41_elementsEvents();
    };
    // screen window events
    function song_41_windowEvents() {
        $('#song_41').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_41_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_41_elementsExtraJS() {
        // screen (song_41) extra code
    };
    // screen elements handler
    function song_41_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_41").on("pagebeforeshow", "#song_41", function(event, ui) {
        Apperyio.CurrentScreen = "song_41";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_41").on("pagecreate", "#song_41", function(event, ui) {

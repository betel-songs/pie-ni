/*
 * JS for song_134 generated by Appery.io
 */
...
function song_134_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_134_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_134';
     ...
     */
    // On Load
    var song_134_onLoad = function() {
        song_134_elementsExtraJS();
        song_134_deviceEvents();
        song_134_windowEvents();
        song_134_elementsEvents();
    };
    // screen window events
    function song_134_windowEvents() {
        $('#song_134').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_134_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_134_elementsExtraJS() {
        // screen (song_134) extra code
    };
    // screen elements handler
    function song_134_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_134").on("pagebeforeshow", "#song_134", function(event, ui) {
        Apperyio.CurrentScreen = "song_134";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_134").on("pagecreate", "#song_134", function(event, ui) {

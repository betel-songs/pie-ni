/*
 * JS for song_97 generated by Appery.io
 */
...
function song_97_js() {
    ...
    Apperyio.CurrentScreen = 'song_97';
     ...
     */
    // On Load
    var song_97_onLoad = function() {
        song_97_elementsExtraJS();
        song_97_deviceEvents();
        song_97_windowEvents();
        song_97_elementsEvents();
    };
    // screen window events
    function song_97_windowEvents() {
        $('#song_97').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_97_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_97_elementsExtraJS() {
        // screen (song_97) extra code
    };
    // screen elements handler
    function song_97_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_97").on("pagebeforeshow", "#song_97", function(event, ui) {
        Apperyio.CurrentScreen = "song_97";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_97").on("pagecreate", "#song_97", function(event, ui) {

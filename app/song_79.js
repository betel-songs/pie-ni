/*
 * JS for song_79 generated by Appery.io
 */
...
function song_79_js() {
    ...
    Apperyio.CurrentScreen = 'song_79';
     ...
     */
    // On Load
    var song_79_onLoad = function() {
        song_79_elementsExtraJS();
        song_79_deviceEvents();
        song_79_windowEvents();
        song_79_elementsEvents();
    };
    // screen window events
    function song_79_windowEvents() {
        $('#song_79').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_79_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_79_elementsExtraJS() {
        // screen (song_79) extra code
    };
    // screen elements handler
    function song_79_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_79").on("pagebeforeshow", "#song_79", function(event, ui) {
        Apperyio.CurrentScreen = "song_79";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_79").on("pagecreate", "#song_79", function(event, ui) {

/*
 * JS for song_25 generated by Appery.io
 */
...
function song_25_js() {
    ...
    Apperyio.CurrentScreen = 'song_25';
     ...
     */
    // On Load
    var song_25_onLoad = function() {
        song_25_elementsExtraJS();
        song_25_deviceEvents();
        song_25_windowEvents();
        song_25_elementsEvents();
    };
    // screen window events
    function song_25_windowEvents() {
        $('#song_25').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_25_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_25_elementsExtraJS() {
        // screen (song_25) extra code
    };
    // screen elements handler
    function song_25_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_25").on("pagebeforeshow", "#song_25", function(event, ui) {
        Apperyio.CurrentScreen = "song_25";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_25").on("pagecreate", "#song_25", function(event, ui) {

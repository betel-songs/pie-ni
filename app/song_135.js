/*
 * JS for song_135 generated by Appery.io
 */
...
function song_135_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_135_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_135';
     ...
     */
    // On Load
    var song_135_onLoad = function() {
        song_135_elementsExtraJS();
        song_135_deviceEvents();
        song_135_windowEvents();
        song_135_elementsEvents();
    };
    // screen window events
    function song_135_windowEvents() {
        $('#song_135').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_135_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_135_elementsExtraJS() {
        // screen (song_135) extra code
    };
    // screen elements handler
    function song_135_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_135").on("pagebeforeshow", "#song_135", function(event, ui) {
        Apperyio.CurrentScreen = "song_135";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_135").on("pagecreate", "#song_135", function(event, ui) {

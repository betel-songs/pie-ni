/*
 * JS for song_36 generated by Appery.io
 */
...
function song_36_js() {
    ...
    Apperyio.CurrentScreen = 'song_36';
     ...
     */
    // On Load
    var song_36_onLoad = function() {
        song_36_elementsExtraJS();
        song_36_deviceEvents();
        song_36_windowEvents();
        song_36_elementsEvents();
    };
    // screen window events
    function song_36_windowEvents() {
        $('#song_36').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_36_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_36_elementsExtraJS() {
        // screen (song_36) extra code
    };
    // screen elements handler
    function song_36_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_36").on("pagebeforeshow", "#song_36", function(event, ui) {
        Apperyio.CurrentScreen = "song_36";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_36").on("pagecreate", "#song_36", function(event, ui) {

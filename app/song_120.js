/*
 * JS for song_120 generated by Appery.io
 */
...
function song_120_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_120_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_120';
     ...
     */
    // On Load
    var song_120_onLoad = function() {
        song_120_elementsExtraJS();
        song_120_deviceEvents();
        song_120_windowEvents();
        song_120_elementsEvents();
    };
    // screen window events
    function song_120_windowEvents() {
        $('#song_120').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_120_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_120_elementsExtraJS() {
        // screen (song_120) extra code
    };
    // screen elements handler
    function song_120_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_120").on("pagebeforeshow", "#song_120", function(event, ui) {
        Apperyio.CurrentScreen = "song_120";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_120").on("pagecreate", "#song_120", function(event, ui) {

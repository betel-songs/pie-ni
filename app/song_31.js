/*
 * JS for song_31 generated by Appery.io
 */
...
function song_31_js() {
    ...
    Apperyio.CurrentScreen = 'song_31';
     ...
     */
    // On Load
    var song_31_onLoad = function() {
        song_31_elementsExtraJS();
        song_31_deviceEvents();
        song_31_windowEvents();
        song_31_elementsEvents();
    };
    // screen window events
    function song_31_windowEvents() {
        $('#song_31').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_31_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_31_elementsExtraJS() {
        // screen (song_31) extra code
    };
    // screen elements handler
    function song_31_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_31").on("pagebeforeshow", "#song_31", function(event, ui) {
        Apperyio.CurrentScreen = "song_31";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_31").on("pagecreate", "#song_31", function(event, ui) {

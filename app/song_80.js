/*
 * JS for song_80 generated by Appery.io
 */
...
function song_80_js() {
    ...
    Apperyio.CurrentScreen = 'song_80';
     ...
     */
    // On Load
    var song_80_onLoad = function() {
        song_80_elementsExtraJS();
        song_80_deviceEvents();
        song_80_windowEvents();
        song_80_elementsEvents();
    };
    // screen window events
    function song_80_windowEvents() {
        $('#song_80').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_80_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_80_elementsExtraJS() {
        // screen (song_80) extra code
    };
    // screen elements handler
    function song_80_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_80").on("pagebeforeshow", "#song_80", function(event, ui) {
        Apperyio.CurrentScreen = "song_80";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_80").on("pagecreate", "#song_80", function(event, ui) {

/*
 * JS for song_81 generated by Appery.io
 */
...
function song_81_js() {
    ...
    Apperyio.CurrentScreen = 'song_81';
     ...
     */
    // On Load
    var song_81_onLoad = function() {
        song_81_elementsExtraJS();
        song_81_deviceEvents();
        song_81_windowEvents();
        song_81_elementsEvents();
    };
    // screen window events
    function song_81_windowEvents() {
        $('#song_81').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_81_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_81_elementsExtraJS() {
        // screen (song_81) extra code
    };
    // screen elements handler
    function song_81_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_81").on("pagebeforeshow", "#song_81", function(event, ui) {
        Apperyio.CurrentScreen = "song_81";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_81").on("pagecreate", "#song_81", function(event, ui) {

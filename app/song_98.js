/*
 * JS for song_98 generated by Appery.io
 */
...
function song_98_js() {
    ...
    Apperyio.CurrentScreen = 'song_98';
     ...
     */
    // On Load
    var song_98_onLoad = function() {
        song_98_elementsExtraJS();
        song_98_deviceEvents();
        song_98_windowEvents();
        song_98_elementsEvents();
    };
    // screen window events
    function song_98_windowEvents() {
        $('#song_98').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_98_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_98_elementsExtraJS() {
        // screen (song_98) extra code
    };
    // screen elements handler
    function song_98_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_98").on("pagebeforeshow", "#song_98", function(event, ui) {
        Apperyio.CurrentScreen = "song_98";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_98").on("pagecreate", "#song_98", function(event, ui) {

/*
 * JS for song_21 generated by Appery.io
 */
...
function song_21_js() {
    ...
    Apperyio.CurrentScreen = 'song_21';
     ...
     */
    // On Load
    var song_21_onLoad = function() {
        song_21_elementsExtraJS();
        song_21_deviceEvents();
        song_21_windowEvents();
        song_21_elementsEvents();
    };
    // screen window events
    function song_21_windowEvents() {
        $('#song_21').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_21_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_21_elementsExtraJS() {
        // screen (song_21) extra code
    };
    // screen elements handler
    function song_21_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_21").on("pagebeforeshow", "#song_21", function(event, ui) {
        Apperyio.CurrentScreen = "song_21";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_21").on("pagecreate", "#song_21", function(event, ui) {

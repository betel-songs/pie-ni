/*
 * JS for song_88 generated by Appery.io
 */
...
function song_88_js() {
    ...
    Apperyio.CurrentScreen = 'song_88';
     ...
     */
    // On Load
    var song_88_onLoad = function() {
        song_88_elementsExtraJS();
        song_88_deviceEvents();
        song_88_windowEvents();
        song_88_elementsEvents();
    };
    // screen window events
    function song_88_windowEvents() {
        $('#song_88').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_88_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_88_elementsExtraJS() {
        // screen (song_88) extra code
    };
    // screen elements handler
    function song_88_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_88").on("pagebeforeshow", "#song_88", function(event, ui) {
        Apperyio.CurrentScreen = "song_88";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_88").on("pagecreate", "#song_88", function(event, ui) {

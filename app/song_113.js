/*
 * JS for song_113 generated by Appery.io
 */
...
function song_113_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_113_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_113';
     ...
     */
    // On Load
    var song_113_onLoad = function() {
        song_113_elementsExtraJS();
        song_113_deviceEvents();
        song_113_windowEvents();
        song_113_elementsEvents();
    };
    // screen window events
    function song_113_windowEvents() {
        $('#song_113').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_113_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_113_elementsExtraJS() {
        // screen (song_113) extra code
    };
    // screen elements handler
    function song_113_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_113").on("pagebeforeshow", "#song_113", function(event, ui) {
        Apperyio.CurrentScreen = "song_113";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_113").on("pagecreate", "#song_113", function(event, ui) {

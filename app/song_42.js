/*
 * JS for song_42 generated by Appery.io
 */
...
function song_42_js() {
    ...
    Apperyio.CurrentScreen = 'song_42';
     ...
     */
    // On Load
    var song_42_onLoad = function() {
        song_42_elementsExtraJS();
        song_42_deviceEvents();
        song_42_windowEvents();
        song_42_elementsEvents();
    };
    // screen window events
    function song_42_windowEvents() {
        $('#song_42').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_42_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_42_elementsExtraJS() {
        // screen (song_42) extra code
    };
    // screen elements handler
    function song_42_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_42").on("pagebeforeshow", "#song_42", function(event, ui) {
        Apperyio.CurrentScreen = "song_42";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_42").on("pagecreate", "#song_42", function(event, ui) {

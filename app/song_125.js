/*
 * JS for song_125 generated by Appery.io
 */
...
function song_125_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_125_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_125';
     ...
     */
    // On Load
    var song_125_onLoad = function() {
        song_125_elementsExtraJS();
        song_125_deviceEvents();
        song_125_windowEvents();
        song_125_elementsEvents();
    };
    // screen window events
    function song_125_windowEvents() {
        $('#song_125').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_125_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_125_elementsExtraJS() {
        // screen (song_125) extra code
    };
    // screen elements handler
    function song_125_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_125").on("pagebeforeshow", "#song_125", function(event, ui) {
        Apperyio.CurrentScreen = "song_125";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_125").on("pagecreate", "#song_125", function(event, ui) {

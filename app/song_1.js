/*
 * JS for song_1 generated by Appery.io
 */
...
function song_1_js() {
     ...
     */
    // On Load
    var song_1_onLoad = function() {
        song_1_elementsExtraJS();
        song_1_deviceEvents();
        song_1_windowEvents();
        song_1_elementsEvents();
    };
    // screen window events
    function song_1_windowEvents() {
        $('#song_1').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_1_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_1_elementsExtraJS() {
        // screen (song_1) extra code
    };
    // screen elements handler
    function song_1_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_1").on("pagebeforeshow", "#song_1", function(event, ui) {
        Apperyio.CurrentScreen = "song_1";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_1").on("pagecreate", "#song_1", function(event, ui) {

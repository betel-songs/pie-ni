/*
 * JS for song_111 generated by Appery.io
 */
...
function song_111_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_111_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_111';
     ...
     */
    // On Load
    var song_111_onLoad = function() {
        song_111_elementsExtraJS();
        song_111_deviceEvents();
        song_111_windowEvents();
        song_111_elementsEvents();
    };
    // screen window events
    function song_111_windowEvents() {
        $('#song_111').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_111_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_111_elementsExtraJS() {
        // screen (song_111) extra code
    };
    // screen elements handler
    function song_111_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_111").on("pagebeforeshow", "#song_111", function(event, ui) {
        Apperyio.CurrentScreen = "song_111";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_111").on("pagecreate", "#song_111", function(event, ui) {

...
function song_138_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_138_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_138';
     ...
     */
    // On Load
    var song_138_onLoad = function() {
        song_138_elementsExtraJS();
        song_138_deviceEvents();
        song_138_windowEvents();
        song_138_elementsEvents();
    };
    // screen window events
    function song_138_windowEvents() {
        $('#song_138').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_138_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_138_elementsExtraJS() {
        // screen (song_138) extra code
    };
    // screen elements handler
    function song_138_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_138").on("pagebeforeshow", "#song_138", function(event, ui) {
        Apperyio.CurrentScreen = "song_138";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_138").on("pagecreate", "#song_138", function(event, ui) {

/*
 * JS for song_128 generated by Appery.io
 */
...
function song_128_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_128_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_128';
     ...
     */
    // On Load
    var song_128_onLoad = function() {
        song_128_elementsExtraJS();
        song_128_deviceEvents();
        song_128_windowEvents();
        song_128_elementsEvents();
    };
    // screen window events
    function song_128_windowEvents() {
        $('#song_128').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_128_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_128_elementsExtraJS() {
        // screen (song_128) extra code
    };
    // screen elements handler
    function song_128_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_128").on("pagebeforeshow", "#song_128", function(event, ui) {
        Apperyio.CurrentScreen = "song_128";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_128").on("pagecreate", "#song_128", function(event, ui) {

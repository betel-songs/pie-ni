/*
 * JS for song_104 generated by Appery.io
 */
...
function song_104_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_104_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_104';
     ...
     */
    // On Load
    var song_104_onLoad = function() {
        song_104_elementsExtraJS();
        song_104_deviceEvents();
        song_104_windowEvents();
        song_104_elementsEvents();
    };
    // screen window events
    function song_104_windowEvents() {
        $('#song_104').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_104_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_104_elementsExtraJS() {
        // screen (song_104) extra code
    };
    // screen elements handler
    function song_104_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_104").on("pagebeforeshow", "#song_104", function(event, ui) {
        Apperyio.CurrentScreen = "song_104";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_104").on("pagecreate", "#song_104", function(event, ui) {

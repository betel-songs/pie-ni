/*
 * JS for song_105 generated by Appery.io
 */
...
function song_105_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_105_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_105';
     ...
     */
    // On Load
    var song_105_onLoad = function() {
        song_105_elementsExtraJS();
        song_105_deviceEvents();
        song_105_windowEvents();
        song_105_elementsEvents();
    };
    // screen window events
    function song_105_windowEvents() {
        $('#song_105').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_105_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_105_elementsExtraJS() {
        // screen (song_105) extra code
    };
    // screen elements handler
    function song_105_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_105").on("pagebeforeshow", "#song_105", function(event, ui) {
        Apperyio.CurrentScreen = "song_105";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_105").on("pagecreate", "#song_105", function(event, ui) {

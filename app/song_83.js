/*
 * JS for song_83 generated by Appery.io
 */
...
function song_83_js() {
    ...
    Apperyio.CurrentScreen = 'song_83';
     ...
     */
    // On Load
    var song_83_onLoad = function() {
        song_83_elementsExtraJS();
        song_83_deviceEvents();
        song_83_windowEvents();
        song_83_elementsEvents();
    };
    // screen window events
    function song_83_windowEvents() {
        $('#song_83').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_83_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_83_elementsExtraJS() {
        // screen (song_83) extra code
    };
    // screen elements handler
    function song_83_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_83").on("pagebeforeshow", "#song_83", function(event, ui) {
        Apperyio.CurrentScreen = "song_83";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_83").on("pagecreate", "#song_83", function(event, ui) {

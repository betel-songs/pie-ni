/*
 * JS for song_26 generated by Appery.io
 */
...
function song_26_js() {
    ...
    Apperyio.CurrentScreen = 'song_26';
     ...
     */
    // On Load
    var song_26_onLoad = function() {
        song_26_elementsExtraJS();
        song_26_deviceEvents();
        song_26_windowEvents();
        song_26_elementsEvents();
    };
    // screen window events
    function song_26_windowEvents() {
        $('#song_26').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_26_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_26_elementsExtraJS() {
        // screen (song_26) extra code
    };
    // screen elements handler
    function song_26_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_26").on("pagebeforeshow", "#song_26", function(event, ui) {
        Apperyio.CurrentScreen = "song_26";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_26").on("pagecreate", "#song_26", function(event, ui) {

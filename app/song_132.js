/*
 * JS for song_132 generated by Appery.io
 */
...
function song_132_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_132_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_132';
     ...
     */
    // On Load
    var song_132_onLoad = function() {
        song_132_elementsExtraJS();
        song_132_deviceEvents();
        song_132_windowEvents();
        song_132_elementsEvents();
    };
    // screen window events
    function song_132_windowEvents() {
        $('#song_132').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_132_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_132_elementsExtraJS() {
        // screen (song_132) extra code
    };
    // screen elements handler
    function song_132_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_132").on("pagebeforeshow", "#song_132", function(event, ui) {
        Apperyio.CurrentScreen = "song_132";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_132").on("pagecreate", "#song_132", function(event, ui) {

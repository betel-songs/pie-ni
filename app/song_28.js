/*
 * JS for song_28 generated by Appery.io
 */
...
function song_28_js() {
    ...
    Apperyio.CurrentScreen = 'song_28';
     ...
     */
    // On Load
    var song_28_onLoad = function() {
        song_28_elementsExtraJS();
        song_28_deviceEvents();
        song_28_windowEvents();
        song_28_elementsEvents();
    };
    // screen window events
    function song_28_windowEvents() {
        $('#song_28').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_28_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_28_elementsExtraJS() {
        // screen (song_28) extra code
    };
    // screen elements handler
    function song_28_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_28").on("pagebeforeshow", "#song_28", function(event, ui) {
        Apperyio.CurrentScreen = "song_28";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_28").on("pagecreate", "#song_28", function(event, ui) {

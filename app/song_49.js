/*
 * JS for song_49 generated by Appery.io
 */
...
function song_49_js() {
    ...
    Apperyio.CurrentScreen = 'song_49';
     ...
     */
    // On Load
    var song_49_onLoad = function() {
        song_49_elementsExtraJS();
        song_49_deviceEvents();
        song_49_windowEvents();
        song_49_elementsEvents();
    };
    // screen window events
    function song_49_windowEvents() {
        $('#song_49').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_49_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_49_elementsExtraJS() {
        // screen (song_49) extra code
    };
    // screen elements handler
    function song_49_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_49").on("pagebeforeshow", "#song_49", function(event, ui) {
        Apperyio.CurrentScreen = "song_49";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_49").on("pagecreate", "#song_49", function(event, ui) {

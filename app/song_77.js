/*
 * JS for song_77 generated by Appery.io
 */
...
function song_77_js() {
    ...
    Apperyio.CurrentScreen = 'song_77';
     ...
     */
    // On Load
    var song_77_onLoad = function() {
        song_77_elementsExtraJS();
        song_77_deviceEvents();
        song_77_windowEvents();
        song_77_elementsEvents();
    };
    // screen window events
    function song_77_windowEvents() {
        $('#song_77').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_77_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_77_elementsExtraJS() {
        // screen (song_77) extra code
    };
    // screen elements handler
    function song_77_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_77").on("pagebeforeshow", "#song_77", function(event, ui) {
        Apperyio.CurrentScreen = "song_77";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_77").on("pagecreate", "#song_77", function(event, ui) {

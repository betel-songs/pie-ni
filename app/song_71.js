/*
 * JS for song_71 generated by Appery.io
 */
...
function song_71_js() {
    ...
    Apperyio.CurrentScreen = 'song_71';
     ...
     */
    // On Load
    var song_71_onLoad = function() {
        song_71_elementsExtraJS();
        song_71_deviceEvents();
        song_71_windowEvents();
        song_71_elementsEvents();
    };
    // screen window events
    function song_71_windowEvents() {
        $('#song_71').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_71_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_71_elementsExtraJS() {
        // screen (song_71) extra code
    };
    // screen elements handler
    function song_71_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_71").on("pagebeforeshow", "#song_71", function(event, ui) {
        Apperyio.CurrentScreen = "song_71";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_71").on("pagecreate", "#song_71", function(event, ui) {

/*
 * JS for song_118 generated by Appery.io
 */
...
function song_118_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_118_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_118';
     ...
     */
    // On Load
    var song_118_onLoad = function() {
        song_118_elementsExtraJS();
        song_118_deviceEvents();
        song_118_windowEvents();
        song_118_elementsEvents();
    };
    // screen window events
    function song_118_windowEvents() {
        $('#song_118').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_118_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_118_elementsExtraJS() {
        // screen (song_118) extra code
    };
    // screen elements handler
    function song_118_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_118").on("pagebeforeshow", "#song_118", function(event, ui) {
        Apperyio.CurrentScreen = "song_118";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_118").on("pagecreate", "#song_118", function(event, ui) {

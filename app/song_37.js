/*
 * JS for song_37 generated by Appery.io
 */
...
function song_37_js() {
    ...
    Apperyio.CurrentScreen = 'song_37';
     ...
     */
    // On Load
    var song_37_onLoad = function() {
        song_37_elementsExtraJS();
        song_37_deviceEvents();
        song_37_windowEvents();
        song_37_elementsEvents();
    };
    // screen window events
    function song_37_windowEvents() {
        $('#song_37').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_37_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_37_elementsExtraJS() {
        // screen (song_37) extra code
    };
    // screen elements handler
    function song_37_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_37").on("pagebeforeshow", "#song_37", function(event, ui) {
        Apperyio.CurrentScreen = "song_37";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_37").on("pagecreate", "#song_37", function(event, ui) {

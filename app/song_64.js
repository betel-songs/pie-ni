/*
 * JS for song_64 generated by Appery.io
 */
...
function song_64_js() {
    ...
    Apperyio.CurrentScreen = 'song_64';
     ...
     */
    // On Load
    var song_64_onLoad = function() {
        song_64_elementsExtraJS();
        song_64_deviceEvents();
        song_64_windowEvents();
        song_64_elementsEvents();
    };
    // screen window events
    function song_64_windowEvents() {
        $('#song_64').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_64_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_64_elementsExtraJS() {
        // screen (song_64) extra code
    };
    // screen elements handler
    function song_64_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_64").on("pagebeforeshow", "#song_64", function(event, ui) {
        Apperyio.CurrentScreen = "song_64";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_64").on("pagecreate", "#song_64", function(event, ui) {

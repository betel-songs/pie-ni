/*
 * JS for song_65 generated by Appery.io
 */
...
function song_65_js() {
    ...
    Apperyio.CurrentScreen = 'song_65';
     ...
     */
    // On Load
    var song_65_onLoad = function() {
        song_65_elementsExtraJS();
        song_65_deviceEvents();
        song_65_windowEvents();
        song_65_elementsEvents();
    };
    // screen window events
    function song_65_windowEvents() {
        $('#song_65').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_65_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_65_elementsExtraJS() {
        // screen (song_65) extra code
    };
    // screen elements handler
    function song_65_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_65").on("pagebeforeshow", "#song_65", function(event, ui) {
        Apperyio.CurrentScreen = "song_65";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_65").on("pagecreate", "#song_65", function(event, ui) {

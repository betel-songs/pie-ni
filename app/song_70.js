/*
 * JS for song_70 generated by Appery.io
 */
...
function song_70_js() {
    ...
    Apperyio.CurrentScreen = 'song_70';
     ...
     */
    // On Load
    var song_70_onLoad = function() {
        song_70_elementsExtraJS();
        song_70_deviceEvents();
        song_70_windowEvents();
        song_70_elementsEvents();
    };
    // screen window events
    function song_70_windowEvents() {
        $('#song_70').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_70_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_70_elementsExtraJS() {
        // screen (song_70) extra code
    };
    // screen elements handler
    function song_70_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_70").on("pagebeforeshow", "#song_70", function(event, ui) {
        Apperyio.CurrentScreen = "song_70";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_70").on("pagecreate", "#song_70", function(event, ui) {

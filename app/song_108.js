/*
 * JS for song_108 generated by Appery.io
 */
...
function song_108_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_108_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_108';
     ...
     */
    // On Load
    var song_108_onLoad = function() {
        song_108_elementsExtraJS();
        song_108_deviceEvents();
        song_108_windowEvents();
        song_108_elementsEvents();
    };
    // screen window events
    function song_108_windowEvents() {
        $('#song_108').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_108_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_108_elementsExtraJS() {
        // screen (song_108) extra code
    };
    // screen elements handler
    function song_108_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_108").on("pagebeforeshow", "#song_108", function(event, ui) {
        Apperyio.CurrentScreen = "song_108";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_108").on("pagecreate", "#song_108", function(event, ui) {

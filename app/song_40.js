/*
 * JS for song_40 generated by Appery.io
 */
...
function song_40_js() {
    ...
    Apperyio.CurrentScreen = 'song_40';
     ...
     */
    // On Load
    var song_40_onLoad = function() {
        song_40_elementsExtraJS();
        song_40_deviceEvents();
        song_40_windowEvents();
        song_40_elementsEvents();
    };
    // screen window events
    function song_40_windowEvents() {
        $('#song_40').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_40_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_40_elementsExtraJS() {
        // screen (song_40) extra code
    };
    // screen elements handler
    function song_40_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_40").on("pagebeforeshow", "#song_40", function(event, ui) {
        Apperyio.CurrentScreen = "song_40";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_40").on("pagecreate", "#song_40", function(event, ui) {

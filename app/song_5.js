/*
 * JS for song_5 generated by Appery.io
 */
...
function song_5_js() {
     ...
     */
    // On Load
    var song_5_onLoad = function() {
        song_5_elementsExtraJS();
        song_5_deviceEvents();
        song_5_windowEvents();
        song_5_elementsEvents();
    };
    // screen window events
    function song_5_windowEvents() {
        $('#song_5').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_5_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_5_elementsExtraJS() {
        // screen (song_5) extra code
    };
    // screen elements handler
    function song_5_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_5").on("pagebeforeshow", "#song_5", function(event, ui) {
        Apperyio.CurrentScreen = "song_5";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_5").on("pagecreate", "#song_5", function(event, ui) {

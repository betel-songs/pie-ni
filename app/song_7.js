/*
 * JS for song_7 generated by Appery.io
 */
...
function song_7_js() {
     ...
     */
    // On Load
    var song_7_onLoad = function() {
        song_7_elementsExtraJS();
        song_7_deviceEvents();
        song_7_windowEvents();
        song_7_elementsEvents();
    };
    // screen window events
    function song_7_windowEvents() {
        $('#song_7').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_7_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_7_elementsExtraJS() {
        // screen (song_7) extra code
    };
    // screen elements handler
    function song_7_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_7").on("pagebeforeshow", "#song_7", function(event, ui) {
        Apperyio.CurrentScreen = "song_7";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_7").on("pagecreate", "#song_7", function(event, ui) {

/*
 * JS for song_87 generated by Appery.io
 */
...
function song_87_js() {
    ...
    Apperyio.CurrentScreen = 'song_87';
     ...
     */
    // On Load
    var song_87_onLoad = function() {
        song_87_elementsExtraJS();
        song_87_deviceEvents();
        song_87_windowEvents();
        song_87_elementsEvents();
    };
    // screen window events
    function song_87_windowEvents() {
        $('#song_87').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_87_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_87_elementsExtraJS() {
        // screen (song_87) extra code
    };
    // screen elements handler
    function song_87_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_87").on("pagebeforeshow", "#song_87", function(event, ui) {
        Apperyio.CurrentScreen = "song_87";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_87").on("pagecreate", "#song_87", function(event, ui) {

/*
 * JS for song_74 generated by Appery.io
 */
...
function song_74_js() {
    ...
    Apperyio.CurrentScreen = 'song_74';
     ...
     */
    // On Load
    var song_74_onLoad = function() {
        song_74_elementsExtraJS();
        song_74_deviceEvents();
        song_74_windowEvents();
        song_74_elementsEvents();
    };
    // screen window events
    function song_74_windowEvents() {
        $('#song_74').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_74_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_74_elementsExtraJS() {
        // screen (song_74) extra code
    };
    // screen elements handler
    function song_74_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_74").on("pagebeforeshow", "#song_74", function(event, ui) {
        Apperyio.CurrentScreen = "song_74";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_74").on("pagecreate", "#song_74", function(event, ui) {

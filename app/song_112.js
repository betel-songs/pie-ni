/*
 * JS for song_112 generated by Appery.io
 */
...
function song_112_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_112_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_112';
     ...
     */
    // On Load
    var song_112_onLoad = function() {
        song_112_elementsExtraJS();
        song_112_deviceEvents();
        song_112_windowEvents();
        song_112_elementsEvents();
    };
    // screen window events
    function song_112_windowEvents() {
        $('#song_112').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_112_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_112_elementsExtraJS() {
        // screen (song_112) extra code
    };
    // screen elements handler
    function song_112_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_112").on("pagebeforeshow", "#song_112", function(event, ui) {
        Apperyio.CurrentScreen = "song_112";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_112").on("pagecreate", "#song_112", function(event, ui) {

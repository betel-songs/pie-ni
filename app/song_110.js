/*
 * JS for song_110 generated by Appery.io
 */
...
function song_110_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_110_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_110';
     ...
     */
    // On Load
    var song_110_onLoad = function() {
        song_110_elementsExtraJS();
        song_110_deviceEvents();
        song_110_windowEvents();
        song_110_elementsEvents();
    };
    // screen window events
    function song_110_windowEvents() {
        $('#song_110').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_110_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_110_elementsExtraJS() {
        // screen (song_110) extra code
    };
    // screen elements handler
    function song_110_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_110").on("pagebeforeshow", "#song_110", function(event, ui) {
        Apperyio.CurrentScreen = "song_110";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_110").on("pagecreate", "#song_110", function(event, ui) {

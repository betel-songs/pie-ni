/*
 * JS for song_2 generated by Appery.io
 */
...
function song_2_js() {
     ...
     */
    // On Load
    var song_2_onLoad = function() {
        song_2_elementsExtraJS();
        song_2_deviceEvents();
        song_2_windowEvents();
        song_2_elementsEvents();
    };
    // screen window events
    function song_2_windowEvents() {
        $('#song_2').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_2_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_2_elementsExtraJS() {
        // screen (song_2) extra code
    };
    // screen elements handler
    function song_2_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_2").on("pagebeforeshow", "#song_2", function(event, ui) {
        Apperyio.CurrentScreen = "song_2";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_2").on("pagecreate", "#song_2", function(event, ui) {

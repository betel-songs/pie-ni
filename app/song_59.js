/*
 * JS for song_59 generated by Appery.io
 */
...
function song_59_js() {
    ...
    Apperyio.CurrentScreen = 'song_59';
     ...
     */
    // On Load
    var song_59_onLoad = function() {
        song_59_elementsExtraJS();
        song_59_deviceEvents();
        song_59_windowEvents();
        song_59_elementsEvents();
    };
    // screen window events
    function song_59_windowEvents() {
        $('#song_59').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_59_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_59_elementsExtraJS() {
        // screen (song_59) extra code
    };
    // screen elements handler
    function song_59_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_59").on("pagebeforeshow", "#song_59", function(event, ui) {
        Apperyio.CurrentScreen = "song_59";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_59").on("pagecreate", "#song_59", function(event, ui) {

/*
 * JS for song_54 generated by Appery.io
 */
...
function song_54_js() {
    ...
    Apperyio.CurrentScreen = 'song_54';
     ...
     */
    // On Load
    var song_54_onLoad = function() {
        song_54_elementsExtraJS();
        song_54_deviceEvents();
        song_54_windowEvents();
        song_54_elementsEvents();
    };
    // screen window events
    function song_54_windowEvents() {
        $('#song_54').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_54_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_54_elementsExtraJS() {
        // screen (song_54) extra code
    };
    // screen elements handler
    function song_54_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_54").on("pagebeforeshow", "#song_54", function(event, ui) {
        Apperyio.CurrentScreen = "song_54";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_54").on("pagecreate", "#song_54", function(event, ui) {

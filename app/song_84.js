/*
 * JS for song_84 generated by Appery.io
 */
...
function song_84_js() {
    ...
    Apperyio.CurrentScreen = 'song_84';
     ...
     */
    // On Load
    var song_84_onLoad = function() {
        song_84_elementsExtraJS();
        song_84_deviceEvents();
        song_84_windowEvents();
        song_84_elementsEvents();
    };
    // screen window events
    function song_84_windowEvents() {
        $('#song_84').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_84_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_84_elementsExtraJS() {
        // screen (song_84) extra code
    };
    // screen elements handler
    function song_84_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_84").on("pagebeforeshow", "#song_84", function(event, ui) {
        Apperyio.CurrentScreen = "song_84";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_84").on("pagecreate", "#song_84", function(event, ui) {

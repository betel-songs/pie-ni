/*
 * JS for song_103 generated by Appery.io
 */
...
function song_103_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_103_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_103';
     ...
     */
    // On Load
    var song_103_onLoad = function() {
        song_103_elementsExtraJS();
        song_103_deviceEvents();
        song_103_windowEvents();
        song_103_elementsEvents();
    };
    // screen window events
    function song_103_windowEvents() {
        $('#song_103').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_103_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_103_elementsExtraJS() {
        // screen (song_103) extra code
    };
    // screen elements handler
    function song_103_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_103").on("pagebeforeshow", "#song_103", function(event, ui) {
        Apperyio.CurrentScreen = "song_103";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_103").on("pagecreate", "#song_103", function(event, ui) {

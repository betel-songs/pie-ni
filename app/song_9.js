/*
 * JS for song_9 generated by Appery.io
 */
...
function song_9_js() {
     ...
     */
    // On Load
    var song_9_onLoad = function() {
        song_9_elementsExtraJS();
        song_9_deviceEvents();
        song_9_windowEvents();
        song_9_elementsEvents();
    };
    // screen window events
    function song_9_windowEvents() {
        $('#song_9').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_9_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_9_elementsExtraJS() {
        // screen (song_9) extra code
    };
    // screen elements handler
    function song_9_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_9").on("pagebeforeshow", "#song_9", function(event, ui) {
        Apperyio.CurrentScreen = "song_9";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_9").on("pagecreate", "#song_9", function(event, ui) {

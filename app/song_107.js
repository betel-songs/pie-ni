/*
 * JS for song_107 generated by Appery.io
 */
...
function song_107_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_107_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_107';
     ...
     */
    // On Load
    var song_107_onLoad = function() {
        song_107_elementsExtraJS();
        song_107_deviceEvents();
        song_107_windowEvents();
        song_107_elementsEvents();
    };
    // screen window events
    function song_107_windowEvents() {
        $('#song_107').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_107_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_107_elementsExtraJS() {
        // screen (song_107) extra code
    };
    // screen elements handler
    function song_107_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_107").on("pagebeforeshow", "#song_107", function(event, ui) {
        Apperyio.CurrentScreen = "song_107";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_107").on("pagecreate", "#song_107", function(event, ui) {

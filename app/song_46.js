/*
 * JS for song_46 generated by Appery.io
 */
...
function song_46_js() {
    ...
    Apperyio.CurrentScreen = 'song_46';
     ...
     */
    // On Load
    var song_46_onLoad = function() {
        song_46_elementsExtraJS();
        song_46_deviceEvents();
        song_46_windowEvents();
        song_46_elementsEvents();
    };
    // screen window events
    function song_46_windowEvents() {
        $('#song_46').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_46_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_46_elementsExtraJS() {
        // screen (song_46) extra code
    };
    // screen elements handler
    function song_46_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_46").on("pagebeforeshow", "#song_46", function(event, ui) {
        Apperyio.CurrentScreen = "song_46";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_46").on("pagecreate", "#song_46", function(event, ui) {

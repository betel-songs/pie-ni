/*
 * JS for song_68 generated by Appery.io
 */
...
function song_68_js() {
    ...
    Apperyio.CurrentScreen = 'song_68';
     ...
     */
    // On Load
    var song_68_onLoad = function() {
        song_68_elementsExtraJS();
        song_68_deviceEvents();
        song_68_windowEvents();
        song_68_elementsEvents();
    };
    // screen window events
    function song_68_windowEvents() {
        $('#song_68').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_68_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_68_elementsExtraJS() {
        // screen (song_68) extra code
    };
    // screen elements handler
    function song_68_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_68").on("pagebeforeshow", "#song_68", function(event, ui) {
        Apperyio.CurrentScreen = "song_68";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_68").on("pagecreate", "#song_68", function(event, ui) {

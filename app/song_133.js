/*
 * JS for song_133 generated by Appery.io
 */
...
function song_133_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_133_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_133';
     ...
     */
    // On Load
    var song_133_onLoad = function() {
        song_133_elementsExtraJS();
        song_133_deviceEvents();
        song_133_windowEvents();
        song_133_elementsEvents();
    };
    // screen window events
    function song_133_windowEvents() {
        $('#song_133').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_133_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_133_elementsExtraJS() {
        // screen (song_133) extra code
    };
    // screen elements handler
    function song_133_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_133").on("pagebeforeshow", "#song_133", function(event, ui) {
        Apperyio.CurrentScreen = "song_133";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_133").on("pagecreate", "#song_133", function(event, ui) {

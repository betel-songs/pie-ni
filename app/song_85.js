/*
 * JS for song_85 generated by Appery.io
 */
...
function song_85_js() {
    ...
    Apperyio.CurrentScreen = 'song_85';
     ...
     */
    // On Load
    var song_85_onLoad = function() {
        song_85_elementsExtraJS();
        song_85_deviceEvents();
        song_85_windowEvents();
        song_85_elementsEvents();
    };
    // screen window events
    function song_85_windowEvents() {
        $('#song_85').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_85_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_85_elementsExtraJS() {
        // screen (song_85) extra code
    };
    // screen elements handler
    function song_85_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_85").on("pagebeforeshow", "#song_85", function(event, ui) {
        Apperyio.CurrentScreen = "song_85";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_85").on("pagecreate", "#song_85", function(event, ui) {

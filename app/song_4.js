/*
 * JS for song_4 generated by Appery.io
 */
...
function song_4_js() {
     ...
     */
    // On Load
    var song_4_onLoad = function() {
        song_4_elementsExtraJS();
        song_4_deviceEvents();
        song_4_windowEvents();
        song_4_elementsEvents();
    };
    // screen window events
    function song_4_windowEvents() {
        $('#song_4').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_4_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_4_elementsExtraJS() {
        // screen (song_4) extra code
    };
    // screen elements handler
    function song_4_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_4").on("pagebeforeshow", "#song_4", function(event, ui) {
        Apperyio.CurrentScreen = "song_4";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_4").on("pagecreate", "#song_4", function(event, ui) {

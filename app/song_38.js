/*
 * JS for song_38 generated by Appery.io
 */
...
function song_38_js() {
    ...
    Apperyio.CurrentScreen = 'song_38';
     ...
     */
    // On Load
    var song_38_onLoad = function() {
        song_38_elementsExtraJS();
        song_38_deviceEvents();
        song_38_windowEvents();
        song_38_elementsEvents();
    };
    // screen window events
    function song_38_windowEvents() {
        $('#song_38').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_38_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_38_elementsExtraJS() {
        // screen (song_38) extra code
    };
    // screen elements handler
    function song_38_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_38").on("pagebeforeshow", "#song_38", function(event, ui) {
        Apperyio.CurrentScreen = "song_38";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_38").on("pagecreate", "#song_38", function(event, ui) {

...
function song_141_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_141_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_141';
     ...
     */
    // On Load
    var song_141_onLoad = function() {
        song_141_elementsExtraJS();
        song_141_deviceEvents();
        song_141_windowEvents();
        song_141_elementsEvents();
    };
    // screen window events
    function song_141_windowEvents() {
        $('#song_141').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_141_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_141_elementsExtraJS() {
        // screen (song_141) extra code
    };
    // screen elements handler
    function song_141_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_141").on("pagebeforeshow", "#song_141", function(event, ui) {
        Apperyio.CurrentScreen = "song_141";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_141").on("pagecreate", "#song_141", function(event, ui) {

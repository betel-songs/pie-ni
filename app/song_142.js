...
function song_142_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_142_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_142';
     ...
     */
    // On Load
    var song_142_onLoad = function() {
        song_142_elementsExtraJS();
        song_142_deviceEvents();
        song_142_windowEvents();
        song_142_elementsEvents();
    };
    // screen window events
    function song_142_windowEvents() {
        $('#song_142').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_142_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_142_elementsExtraJS() {
        // screen (song_142) extra code
    };
    // screen elements handler
    function song_142_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_142").on("pagebeforeshow", "#song_142", function(event, ui) {
        Apperyio.CurrentScreen = "song_142";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_142").on("pagecreate", "#song_142", function(event, ui) {

/*
 * JS for song_116 generated by Appery.io
 */
...
function song_116_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_116_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_116';
     ...
     */
    // On Load
    var song_116_onLoad = function() {
        song_116_elementsExtraJS();
        song_116_deviceEvents();
        song_116_windowEvents();
        song_116_elementsEvents();
    };
    // screen window events
    function song_116_windowEvents() {
        $('#song_116').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_116_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_116_elementsExtraJS() {
        // screen (song_116) extra code
    };
    // screen elements handler
    function song_116_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_116").on("pagebeforeshow", "#song_116", function(event, ui) {
        Apperyio.CurrentScreen = "song_116";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_116").on("pagecreate", "#song_116", function(event, ui) {

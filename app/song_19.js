/*
 * JS for song_19 generated by Appery.io
 */
...
function song_19_js() {
    ...
    Apperyio.CurrentScreen = 'song_19';
     ...
     */
    // On Load
    var song_19_onLoad = function() {
        song_19_elementsExtraJS();
        song_19_deviceEvents();
        song_19_windowEvents();
        song_19_elementsEvents();
    };
    // screen window events
    function song_19_windowEvents() {
        $('#song_19').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_19_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_19_elementsExtraJS() {
        // screen (song_19) extra code
    };
    // screen elements handler
    function song_19_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_19").on("pagebeforeshow", "#song_19", function(event, ui) {
        Apperyio.CurrentScreen = "song_19";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_19").on("pagecreate", "#song_19", function(event, ui) {

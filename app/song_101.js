/*
 * JS for song_101 generated by Appery.io
 */
...
function song_101_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_101_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_101';
     ...
     */
    // On Load
    var song_101_onLoad = function() {
        song_101_elementsExtraJS();
        song_101_deviceEvents();
        song_101_windowEvents();
        song_101_elementsEvents();
    };
    // screen window events
    function song_101_windowEvents() {
        $('#song_101').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_101_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_101_elementsExtraJS() {
        // screen (song_101) extra code
    };
    // screen elements handler
    function song_101_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_101").on("pagebeforeshow", "#song_101", function(event, ui) {
        Apperyio.CurrentScreen = "song_101";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_101").on("pagecreate", "#song_101", function(event, ui) {

/*
 * JS for song_72 generated by Appery.io
 */
...
function song_72_js() {
    ...
    Apperyio.CurrentScreen = 'song_72';
     ...
     */
    // On Load
    var song_72_onLoad = function() {
        song_72_elementsExtraJS();
        song_72_deviceEvents();
        song_72_windowEvents();
        song_72_elementsEvents();
    };
    // screen window events
    function song_72_windowEvents() {
        $('#song_72').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_72_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_72_elementsExtraJS() {
        // screen (song_72) extra code
    };
    // screen elements handler
    function song_72_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_72").on("pagebeforeshow", "#song_72", function(event, ui) {
        Apperyio.CurrentScreen = "song_72";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_72").on("pagecreate", "#song_72", function(event, ui) {

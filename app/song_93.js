/*
 * JS for song_93 generated by Appery.io
 */
...
function song_93_js() {
    ...
    Apperyio.CurrentScreen = 'song_93';
     ...
     */
    // On Load
    var song_93_onLoad = function() {
        song_93_elementsExtraJS();
        song_93_deviceEvents();
        song_93_windowEvents();
        song_93_elementsEvents();
    };
    // screen window events
    function song_93_windowEvents() {
        $('#song_93').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_93_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_93_elementsExtraJS() {
        // screen (song_93) extra code
    };
    // screen elements handler
    function song_93_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_93").on("pagebeforeshow", "#song_93", function(event, ui) {
        Apperyio.CurrentScreen = "song_93";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_93").on("pagecreate", "#song_93", function(event, ui) {

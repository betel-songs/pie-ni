/*
 * JS for song_92 generated by Appery.io
 */
...
function song_92_js() {
    ...
    Apperyio.CurrentScreen = 'song_92';
     ...
     */
    // On Load
    var song_92_onLoad = function() {
        song_92_elementsExtraJS();
        song_92_deviceEvents();
        song_92_windowEvents();
        song_92_elementsEvents();
    };
    // screen window events
    function song_92_windowEvents() {
        $('#song_92').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_92_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_92_elementsExtraJS() {
        // screen (song_92) extra code
    };
    // screen elements handler
    function song_92_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_92").on("pagebeforeshow", "#song_92", function(event, ui) {
        Apperyio.CurrentScreen = "song_92";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_92").on("pagecreate", "#song_92", function(event, ui) {

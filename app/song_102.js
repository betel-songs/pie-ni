/*
 * JS for song_102 generated by Appery.io
 */
...
function song_102_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_102_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_102';
     ...
     */
    // On Load
    var song_102_onLoad = function() {
        song_102_elementsExtraJS();
        song_102_deviceEvents();
        song_102_windowEvents();
        song_102_elementsEvents();
    };
    // screen window events
    function song_102_windowEvents() {
        $('#song_102').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_102_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_102_elementsExtraJS() {
        // screen (song_102) extra code
    };
    // screen elements handler
    function song_102_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_102").on("pagebeforeshow", "#song_102", function(event, ui) {
        Apperyio.CurrentScreen = "song_102";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_102").on("pagecreate", "#song_102", function(event, ui) {

/*
 * JS for song_121 generated by Appery.io
 */
...
function song_121_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_121_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_121';
     ...
     */
    // On Load
    var song_121_onLoad = function() {
        song_121_elementsExtraJS();
        song_121_deviceEvents();
        song_121_windowEvents();
        song_121_elementsEvents();
    };
    // screen window events
    function song_121_windowEvents() {
        $('#song_121').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_121_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_121_elementsExtraJS() {
        // screen (song_121) extra code
    };
    // screen elements handler
    function song_121_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_121").on("pagebeforeshow", "#song_121", function(event, ui) {
        Apperyio.CurrentScreen = "song_121";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_121").on("pagecreate", "#song_121", function(event, ui) {

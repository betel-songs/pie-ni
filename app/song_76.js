/*
 * JS for song_76 generated by Appery.io
 */
...
function song_76_js() {
    ...
    Apperyio.CurrentScreen = 'song_76';
     ...
     */
    // On Load
    var song_76_onLoad = function() {
        song_76_elementsExtraJS();
        song_76_deviceEvents();
        song_76_windowEvents();
        song_76_elementsEvents();
    };
    // screen window events
    function song_76_windowEvents() {
        $('#song_76').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_76_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_76_elementsExtraJS() {
        // screen (song_76) extra code
    };
    // screen elements handler
    function song_76_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_76").on("pagebeforeshow", "#song_76", function(event, ui) {
        Apperyio.CurrentScreen = "song_76";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_76").on("pagecreate", "#song_76", function(event, ui) {

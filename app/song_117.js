/*
 * JS for song_117 generated by Appery.io
 */
...
function song_117_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_117_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_117';
     ...
     */
    // On Load
    var song_117_onLoad = function() {
        song_117_elementsExtraJS();
        song_117_deviceEvents();
        song_117_windowEvents();
        song_117_elementsEvents();
    };
    // screen window events
    function song_117_windowEvents() {
        $('#song_117').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_117_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_117_elementsExtraJS() {
        // screen (song_117) extra code
    };
    // screen elements handler
    function song_117_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_117").on("pagebeforeshow", "#song_117", function(event, ui) {
        Apperyio.CurrentScreen = "song_117";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_117").on("pagecreate", "#song_117", function(event, ui) {

/*
 * JS for song_32 generated by Appery.io
 */
...
function song_32_js() {
    ...
    Apperyio.CurrentScreen = 'song_32';
     ...
     */
    // On Load
    var song_32_onLoad = function() {
        song_32_elementsExtraJS();
        song_32_deviceEvents();
        song_32_windowEvents();
        song_32_elementsEvents();
    };
    // screen window events
    function song_32_windowEvents() {
        $('#song_32').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_32_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_32_elementsExtraJS() {
        // screen (song_32) extra code
    };
    // screen elements handler
    function song_32_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_32").on("pagebeforeshow", "#song_32", function(event, ui) {
        Apperyio.CurrentScreen = "song_32";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_32").on("pagecreate", "#song_32", function(event, ui) {

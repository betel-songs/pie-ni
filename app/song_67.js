/*
 * JS for song_67 generated by Appery.io
 */
...
function song_67_js() {
    ...
    Apperyio.CurrentScreen = 'song_67';
     ...
     */
    // On Load
    var song_67_onLoad = function() {
        song_67_elementsExtraJS();
        song_67_deviceEvents();
        song_67_windowEvents();
        song_67_elementsEvents();
    };
    // screen window events
    function song_67_windowEvents() {
        $('#song_67').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_67_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_67_elementsExtraJS() {
        // screen (song_67) extra code
    };
    // screen elements handler
    function song_67_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_67").on("pagebeforeshow", "#song_67", function(event, ui) {
        Apperyio.CurrentScreen = "song_67";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_67").on("pagecreate", "#song_67", function(event, ui) {

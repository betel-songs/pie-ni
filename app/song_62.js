/*
 * JS for song_62 generated by Appery.io
 */
...
function song_62_js() {
    ...
    Apperyio.CurrentScreen = 'song_62';
     ...
     */
    // On Load
    var song_62_onLoad = function() {
        song_62_elementsExtraJS();
        song_62_deviceEvents();
        song_62_windowEvents();
        song_62_elementsEvents();
    };
    // screen window events
    function song_62_windowEvents() {
        $('#song_62').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_62_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_62_elementsExtraJS() {
        // screen (song_62) extra code
    };
    // screen elements handler
    function song_62_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_62").on("pagebeforeshow", "#song_62", function(event, ui) {
        Apperyio.CurrentScreen = "song_62";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_62").on("pagecreate", "#song_62", function(event, ui) {

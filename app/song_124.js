/*
 * JS for song_124 generated by Appery.io
 */
...
function song_124_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_124_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_124';
     ...
     */
    // On Load
    var song_124_onLoad = function() {
        song_124_elementsExtraJS();
        song_124_deviceEvents();
        song_124_windowEvents();
        song_124_elementsEvents();
    };
    // screen window events
    function song_124_windowEvents() {
        $('#song_124').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_124_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_124_elementsExtraJS() {
        // screen (song_124) extra code
    };
    // screen elements handler
    function song_124_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_124").on("pagebeforeshow", "#song_124", function(event, ui) {
        Apperyio.CurrentScreen = "song_124";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_124").on("pagecreate", "#song_124", function(event, ui) {

/*
 * JS for song_78 generated by Appery.io
 */
...
function song_78_js() {
    ...
    Apperyio.CurrentScreen = 'song_78';
     ...
     */
    // On Load
    var song_78_onLoad = function() {
        song_78_elementsExtraJS();
        song_78_deviceEvents();
        song_78_windowEvents();
        song_78_elementsEvents();
    };
    // screen window events
    function song_78_windowEvents() {
        $('#song_78').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_78_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_78_elementsExtraJS() {
        // screen (song_78) extra code
    };
    // screen elements handler
    function song_78_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_78").on("pagebeforeshow", "#song_78", function(event, ui) {
        Apperyio.CurrentScreen = "song_78";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_78").on("pagecreate", "#song_78", function(event, ui) {

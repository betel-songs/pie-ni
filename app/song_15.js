/*
 * JS for song_15 generated by Appery.io
 */
...
function song_15_js() {
    ...
    Apperyio.CurrentScreen = 'song_15';
     ...
     */
    // On Load
    var song_15_onLoad = function() {
        song_15_elementsExtraJS();
        song_15_deviceEvents();
        song_15_windowEvents();
        song_15_elementsEvents();
    };
    // screen window events
    function song_15_windowEvents() {
        $('#song_15').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_15_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_15_elementsExtraJS() {
        // screen (song_15) extra code
    };
    // screen elements handler
    function song_15_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_15").on("pagebeforeshow", "#song_15", function(event, ui) {
        Apperyio.CurrentScreen = "song_15";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_15").on("pagecreate", "#song_15", function(event, ui) {

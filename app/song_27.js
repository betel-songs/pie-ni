/*
 * JS for song_27 generated by Appery.io
 */
...
function song_27_js() {
    ...
    Apperyio.CurrentScreen = 'song_27';
     ...
     */
    // On Load
    var song_27_onLoad = function() {
        song_27_elementsExtraJS();
        song_27_deviceEvents();
        song_27_windowEvents();
        song_27_elementsEvents();
    };
    // screen window events
    function song_27_windowEvents() {
        $('#song_27').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_27_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_27_elementsExtraJS() {
        // screen (song_27) extra code
    };
    // screen elements handler
    function song_27_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_27").on("pagebeforeshow", "#song_27", function(event, ui) {
        Apperyio.CurrentScreen = "song_27";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_27").on("pagecreate", "#song_27", function(event, ui) {

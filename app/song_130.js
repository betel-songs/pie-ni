/*
 * JS for song_130 generated by Appery.io
 */
...
function song_130_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_130_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_130';
     ...
     */
    // On Load
    var song_130_onLoad = function() {
        song_130_elementsExtraJS();
        song_130_deviceEvents();
        song_130_windowEvents();
        song_130_elementsEvents();
    };
    // screen window events
    function song_130_windowEvents() {
        $('#song_130').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_130_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_130_elementsExtraJS() {
        // screen (song_130) extra code
    };
    // screen elements handler
    function song_130_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_130").on("pagebeforeshow", "#song_130", function(event, ui) {
        Apperyio.CurrentScreen = "song_130";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_130").on("pagecreate", "#song_130", function(event, ui) {

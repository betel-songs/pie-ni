/*
 * JS for song_122 generated by Appery.io
 */
...
function song_122_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_122_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_122';
     ...
     */
    // On Load
    var song_122_onLoad = function() {
        song_122_elementsExtraJS();
        song_122_deviceEvents();
        song_122_windowEvents();
        song_122_elementsEvents();
    };
    // screen window events
    function song_122_windowEvents() {
        $('#song_122').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_122_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_122_elementsExtraJS() {
        // screen (song_122) extra code
    };
    // screen elements handler
    function song_122_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_122").on("pagebeforeshow", "#song_122", function(event, ui) {
        Apperyio.CurrentScreen = "song_122";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_122").on("pagecreate", "#song_122", function(event, ui) {

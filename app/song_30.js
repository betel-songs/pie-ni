/*
 * JS for song_30 generated by Appery.io
 */
...
function song_30_js() {
    ...
    Apperyio.CurrentScreen = 'song_30';
     ...
     */
    // On Load
    var song_30_onLoad = function() {
        song_30_elementsExtraJS();
        song_30_deviceEvents();
        song_30_windowEvents();
        song_30_elementsEvents();
    };
    // screen window events
    function song_30_windowEvents() {
        $('#song_30').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_30_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_30_elementsExtraJS() {
        // screen (song_30) extra code
    };
    // screen elements handler
    function song_30_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_30").on("pagebeforeshow", "#song_30", function(event, ui) {
        Apperyio.CurrentScreen = "song_30";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_30").on("pagecreate", "#song_30", function(event, ui) {

/*
 * JS for song_126 generated by Appery.io
 */
...
function song_126_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_126_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_126';
     ...
     */
    // On Load
    var song_126_onLoad = function() {
        song_126_elementsExtraJS();
        song_126_deviceEvents();
        song_126_windowEvents();
        song_126_elementsEvents();
    };
    // screen window events
    function song_126_windowEvents() {
        $('#song_126').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_126_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_126_elementsExtraJS() {
        // screen (song_126) extra code
    };
    // screen elements handler
    function song_126_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_126").on("pagebeforeshow", "#song_126", function(event, ui) {
        Apperyio.CurrentScreen = "song_126";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_126").on("pagecreate", "#song_126", function(event, ui) {

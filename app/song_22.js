/*
 * JS for song_22 generated by Appery.io
 */
...
function song_22_js() {
    ...
    Apperyio.CurrentScreen = 'song_22';
     ...
     */
    // On Load
    var song_22_onLoad = function() {
        song_22_elementsExtraJS();
        song_22_deviceEvents();
        song_22_windowEvents();
        song_22_elementsEvents();
    };
    // screen window events
    function song_22_windowEvents() {
        $('#song_22').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_22_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_22_elementsExtraJS() {
        // screen (song_22) extra code
    };
    // screen elements handler
    function song_22_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_22").on("pagebeforeshow", "#song_22", function(event, ui) {
        Apperyio.CurrentScreen = "song_22";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_22").on("pagecreate", "#song_22", function(event, ui) {

/*
 * JS for song_86 generated by Appery.io
 */
...
function song_86_js() {
    ...
    Apperyio.CurrentScreen = 'song_86';
     ...
     */
    // On Load
    var song_86_onLoad = function() {
        song_86_elementsExtraJS();
        song_86_deviceEvents();
        song_86_windowEvents();
        song_86_elementsEvents();
    };
    // screen window events
    function song_86_windowEvents() {
        $('#song_86').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_86_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_86_elementsExtraJS() {
        // screen (song_86) extra code
    };
    // screen elements handler
    function song_86_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_86").on("pagebeforeshow", "#song_86", function(event, ui) {
        Apperyio.CurrentScreen = "song_86";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_86").on("pagecreate", "#song_86", function(event, ui) {

/*
 * JS for song_18 generated by Appery.io
 */
...
function song_18_js() {
    ...
    Apperyio.CurrentScreen = 'song_18';
     ...
     */
    // On Load
    var song_18_onLoad = function() {
        song_18_elementsExtraJS();
        song_18_deviceEvents();
        song_18_windowEvents();
        song_18_elementsEvents();
    };
    // screen window events
    function song_18_windowEvents() {
        $('#song_18').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_18_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_18_elementsExtraJS() {
        // screen (song_18) extra code
    };
    // screen elements handler
    function song_18_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_18").on("pagebeforeshow", "#song_18", function(event, ui) {
        Apperyio.CurrentScreen = "song_18";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_18").on("pagecreate", "#song_18", function(event, ui) {

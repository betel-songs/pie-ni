/*
 * JS for song_44 generated by Appery.io
 */
...
function song_44_js() {
    ...
    Apperyio.CurrentScreen = 'song_44';
     ...
     */
    // On Load
    var song_44_onLoad = function() {
        song_44_elementsExtraJS();
        song_44_deviceEvents();
        song_44_windowEvents();
        song_44_elementsEvents();
    };
    // screen window events
    function song_44_windowEvents() {
        $('#song_44').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_44_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_44_elementsExtraJS() {
        // screen (song_44) extra code
    };
    // screen elements handler
    function song_44_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_44").on("pagebeforeshow", "#song_44", function(event, ui) {
        Apperyio.CurrentScreen = "song_44";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_44").on("pagecreate", "#song_44", function(event, ui) {

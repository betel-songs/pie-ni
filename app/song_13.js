/*
 * JS for song_13 generated by Appery.io
 */
...
function song_13_js() {
    ...
    Apperyio.CurrentScreen = 'song_13';
     ...
     */
    // On Load
    var song_13_onLoad = function() {
        song_13_elementsExtraJS();
        song_13_deviceEvents();
        song_13_windowEvents();
        song_13_elementsEvents();
    };
    // screen window events
    function song_13_windowEvents() {
        $('#song_13').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_13_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_13_elementsExtraJS() {
        // screen (song_13) extra code
    };
    // screen elements handler
    function song_13_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_13").on("pagebeforeshow", "#song_13", function(event, ui) {
        Apperyio.CurrentScreen = "song_13";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_13").on("pagecreate", "#song_13", function(event, ui) {

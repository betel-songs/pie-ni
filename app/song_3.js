/*
 * JS for song_3 generated by Appery.io
 */
...
function song_3_js() {
     ...
     */
    // On Load
    var song_3_onLoad = function() {
        song_3_elementsExtraJS();
        song_3_deviceEvents();
        song_3_windowEvents();
        song_3_elementsEvents();
    };
    // screen window events
    function song_3_windowEvents() {
        $('#song_3').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_3_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_3_elementsExtraJS() {
        // screen (song_3) extra code
    };
    // screen elements handler
    function song_3_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_3").on("pagebeforeshow", "#song_3", function(event, ui) {
        Apperyio.CurrentScreen = "song_3";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_3").on("pagecreate", "#song_3", function(event, ui) {

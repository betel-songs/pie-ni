/*
 * JS for song_23 generated by Appery.io
 */
...
function song_23_js() {
    ...
    Apperyio.CurrentScreen = 'song_23';
     ...
     */
    // On Load
    var song_23_onLoad = function() {
        song_23_elementsExtraJS();
        song_23_deviceEvents();
        song_23_windowEvents();
        song_23_elementsEvents();
    };
    // screen window events
    function song_23_windowEvents() {
        $('#song_23').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_23_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_23_elementsExtraJS() {
        // screen (song_23) extra code
    };
    // screen elements handler
    function song_23_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_23").on("pagebeforeshow", "#song_23", function(event, ui) {
        Apperyio.CurrentScreen = "song_23";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_23").on("pagecreate", "#song_23", function(event, ui) {

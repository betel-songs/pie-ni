/*
 * JS for song_129 generated by Appery.io
 */
...
function song_129_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_129_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_129';
     ...
     */
    // On Load
    var song_129_onLoad = function() {
        song_129_elementsExtraJS();
        song_129_deviceEvents();
        song_129_windowEvents();
        song_129_elementsEvents();
    };
    // screen window events
    function song_129_windowEvents() {
        $('#song_129').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_129_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_129_elementsExtraJS() {
        // screen (song_129) extra code
    };
    // screen elements handler
    function song_129_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_129").on("pagebeforeshow", "#song_129", function(event, ui) {
        Apperyio.CurrentScreen = "song_129";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_129").on("pagecreate", "#song_129", function(event, ui) {

/*
 * JS for song_58 generated by Appery.io
 */
...
function song_58_js() {
    ...
    Apperyio.CurrentScreen = 'song_58';
     ...
     */
    // On Load
    var song_58_onLoad = function() {
        song_58_elementsExtraJS();
        song_58_deviceEvents();
        song_58_windowEvents();
        song_58_elementsEvents();
    };
    // screen window events
    function song_58_windowEvents() {
        $('#song_58').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_58_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_58_elementsExtraJS() {
        // screen (song_58) extra code
    };
    // screen elements handler
    function song_58_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_58").on("pagebeforeshow", "#song_58", function(event, ui) {
        Apperyio.CurrentScreen = "song_58";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_58").on("pagecreate", "#song_58", function(event, ui) {

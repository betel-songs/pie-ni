/*
 * JS for song_33 generated by Appery.io
 */
...
function song_33_js() {
    ...
    Apperyio.CurrentScreen = 'song_33';
     ...
     */
    // On Load
    var song_33_onLoad = function() {
        song_33_elementsExtraJS();
        song_33_deviceEvents();
        song_33_windowEvents();
        song_33_elementsEvents();
    };
    // screen window events
    function song_33_windowEvents() {
        $('#song_33').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_33_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_33_elementsExtraJS() {
        // screen (song_33) extra code
    };
    // screen elements handler
    function song_33_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_33").on("pagebeforeshow", "#song_33", function(event, ui) {
        Apperyio.CurrentScreen = "song_33";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_33").on("pagecreate", "#song_33", function(event, ui) {

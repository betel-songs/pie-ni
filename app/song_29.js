/*
 * JS for song_29 generated by Appery.io
 */
...
function song_29_js() {
    ...
    Apperyio.CurrentScreen = 'song_29';
     ...
     */
    // On Load
    var song_29_onLoad = function() {
        song_29_elementsExtraJS();
        song_29_deviceEvents();
        song_29_windowEvents();
        song_29_elementsEvents();
    };
    // screen window events
    function song_29_windowEvents() {
        $('#song_29').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_29_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_29_elementsExtraJS() {
        // screen (song_29) extra code
    };
    // screen elements handler
    function song_29_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_29").on("pagebeforeshow", "#song_29", function(event, ui) {
        Apperyio.CurrentScreen = "song_29";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_29").on("pagecreate", "#song_29", function(event, ui) {

/*
 * JS for song_114 generated by Appery.io
 */
...
function song_114_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_114_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_114';
     ...
     */
    // On Load
    var song_114_onLoad = function() {
        song_114_elementsExtraJS();
        song_114_deviceEvents();
        song_114_windowEvents();
        song_114_elementsEvents();
    };
    // screen window events
    function song_114_windowEvents() {
        $('#song_114').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_114_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_114_elementsExtraJS() {
        // screen (song_114) extra code
    };
    // screen elements handler
    function song_114_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_114").on("pagebeforeshow", "#song_114", function(event, ui) {
        Apperyio.CurrentScreen = "song_114";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_114").on("pagecreate", "#song_114", function(event, ui) {

/*
 * JS for song_57 generated by Appery.io
 */
...
function song_57_js() {
    ...
    Apperyio.CurrentScreen = 'song_57';
     ...
     */
    // On Load
    var song_57_onLoad = function() {
        song_57_elementsExtraJS();
        song_57_deviceEvents();
        song_57_windowEvents();
        song_57_elementsEvents();
    };
    // screen window events
    function song_57_windowEvents() {
        $('#song_57').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_57_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_57_elementsExtraJS() {
        // screen (song_57) extra code
    };
    // screen elements handler
    function song_57_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_57").on("pagebeforeshow", "#song_57", function(event, ui) {
        Apperyio.CurrentScreen = "song_57";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_57").on("pagecreate", "#song_57", function(event, ui) {

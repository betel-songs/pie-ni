/*
 * JS for song_56 generated by Appery.io
 */
...
function song_56_js() {
    ...
    Apperyio.CurrentScreen = 'song_56';
     ...
     */
    // On Load
    var song_56_onLoad = function() {
        song_56_elementsExtraJS();
        song_56_deviceEvents();
        song_56_windowEvents();
        song_56_elementsEvents();
    };
    // screen window events
    function song_56_windowEvents() {
        $('#song_56').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_56_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_56_elementsExtraJS() {
        // screen (song_56) extra code
    };
    // screen elements handler
    function song_56_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_56").on("pagebeforeshow", "#song_56", function(event, ui) {
        Apperyio.CurrentScreen = "song_56";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_56").on("pagecreate", "#song_56", function(event, ui) {

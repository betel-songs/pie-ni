...
function song_140_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_140_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_140';
     ...
     */
    // On Load
    var song_140_onLoad = function() {
        song_140_elementsExtraJS();
        song_140_deviceEvents();
        song_140_windowEvents();
        song_140_elementsEvents();
    };
    // screen window events
    function song_140_windowEvents() {
        $('#song_140').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_140_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_140_elementsExtraJS() {
        // screen (song_140) extra code
    };
    // screen elements handler
    function song_140_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_140").on("pagebeforeshow", "#song_140", function(event, ui) {
        Apperyio.CurrentScreen = "song_140";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_140").on("pagecreate", "#song_140", function(event, ui) {

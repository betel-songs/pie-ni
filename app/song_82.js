/*
 * JS for song_82 generated by Appery.io
 */
...
function song_82_js() {
    ...
    Apperyio.CurrentScreen = 'song_82';
     ...
     */
    // On Load
    var song_82_onLoad = function() {
        song_82_elementsExtraJS();
        song_82_deviceEvents();
        song_82_windowEvents();
        song_82_elementsEvents();
    };
    // screen window events
    function song_82_windowEvents() {
        $('#song_82').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_82_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_82_elementsExtraJS() {
        // screen (song_82) extra code
    };
    // screen elements handler
    function song_82_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_82").on("pagebeforeshow", "#song_82", function(event, ui) {
        Apperyio.CurrentScreen = "song_82";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_82").on("pagecreate", "#song_82", function(event, ui) {

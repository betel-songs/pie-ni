/*
 * JS for song_60 generated by Appery.io
 */
...
function song_60_js() {
    ...
    Apperyio.CurrentScreen = 'song_60';
     ...
     */
    // On Load
    var song_60_onLoad = function() {
        song_60_elementsExtraJS();
        song_60_deviceEvents();
        song_60_windowEvents();
        song_60_elementsEvents();
    };
    // screen window events
    function song_60_windowEvents() {
        $('#song_60').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_60_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_60_elementsExtraJS() {
        // screen (song_60) extra code
    };
    // screen elements handler
    function song_60_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_60").on("pagebeforeshow", "#song_60", function(event, ui) {
        Apperyio.CurrentScreen = "song_60";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_60").on("pagecreate", "#song_60", function(event, ui) {

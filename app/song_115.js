/*
 * JS for song_115 generated by Appery.io
 */
...
function song_115_js() {
    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'html_5': 'song_115_html_5'
    };
    ...
    Apperyio.CurrentScreen = 'song_115';
     ...
     */
    // On Load
    var song_115_onLoad = function() {
        song_115_elementsExtraJS();
        song_115_deviceEvents();
        song_115_windowEvents();
        song_115_elementsEvents();
    };
    // screen window events
    function song_115_windowEvents() {
        $('#song_115').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song_115_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song_115_elementsExtraJS() {
        // screen (song_115) extra code
    };
    // screen elements handler
    function song_115_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song_115").on("pagebeforeshow", "#song_115", function(event, ui) {
        Apperyio.CurrentScreen = "song_115";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song_115").on("pagecreate", "#song_115", function(event, ui) {
